                                ...
                                <div class="tab-pane fade show active data-pribadi" id="data-pribadi">
                                    <div class="row g-3">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="nama_pend" class="form-control" id="yourPassword"
                                                value="{{ old('nama_pend', $ktp[0]->nama_pend) }}" required>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="tempat_lahir" class="form-control" id="yourPassword"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="date" name="tgl_lahir" class="form-control" id="yourPassword"
                                                value="{{ old('tgl_lahir', $ktp[0]->tgl_lahir) }}" required>
                                            <div class="invalid-feedback">Please enter your password!</div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" id="validationCustom04" name="agama" required>
                                                ...
                                                <option value="Kong Hu Chu"
                                                    @if ($ktp[0]->agama === 'Kong Hu Chu') selected @endif>Kong Hu Chu</option>
                                            </select>
                                            <div class="invalid-feedback">
                                                Pilih Agama anda!
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select @error('status_pernikahan') is-invalid @enderror"
                                                ...
                                                <option value="Sudah Menikah"
                                                    @if ($ktp[0]->status_pernikahan === 'Sudah Menikah') selected @endif>Sudah Menikah</option>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select @error('pekerjaan') is-invalid @enderror"
                                                ...
                                                <option value="Wiraswasta"
                                                    @if ($ktp[0]->pekerjaan === 'Wiraswasta') selected @endif>Wiraswasta</option>
                                            </select>
                                            <div class="invalid-feedback">Please enter your password!</div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="kewarganegaraan" class="form-control"
                                                id="yourPassword"
                                                value="{{ old('kewarganegaraan', $ktp[0]->kewarganegaraan) }}" required>
                                            <div class="invalid-feedback">Please enter your password!</div>
                                        </div>
                                        <div class="col-12">
                                            <a href="{{ asset('storage/' . $ktp[0]->dok_fc_kk) }}" target="_blank"
                                                rel="noopener noreferrer" class="btn btn-secondary">File Dokumen KK</a>
                                        </div>
                                        <div class="col-12">
